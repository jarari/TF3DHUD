...
namespace TF3DHud::Animations
{
	...
	struct DebugSnapshot
	{
		...
		std::uint32_t loadingDefaultSubgraphHandleCount{ 0 };
		std::uint32_t loadingDefaultSubgraphHandleShown{ 0 };
		std::uint32_t loadingDefaultSubgraphIdCount{ 0 };
		std::uint32_t loadingDefaultSubgraphIdShown{ 0 };
		...
		std::uint32_t loadingWeaponSubgraphHandleCount{ 0 };
		std::uint32_t loadingWeaponSubgraphHandleShown{ 0 };
		std::uint32_t loadingWeaponSubgraphIdCount{ 0 };
		std::uint32_t loadingWeaponSubgraphIdShown{ 0 };
		...
		std::array<std::uint64_t, kMaxSubgraphDebugRequestEntries> loadingDefaultSubgraphHandles{};
		std::array<std::uint64_t, kMaxSubgraphDebugRequestEntries> loadingDefaultSubgraphIds{};
		...
		std::array<std::uint64_t, kMaxSubgraphDebugRequestEntries> loadingWeaponSubgraphHandles{};
		std::array<std::uint64_t, kMaxSubgraphDebugRequestEntries> loadingWeaponSubgraphIds{};
